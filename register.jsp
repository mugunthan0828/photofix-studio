...
<div class="signup-form">
    <form action="regserve" method="post" onsubmit="return passvalid()">
		<h2>Register</h2>
        ...
        <div class="form-group">
			<div class="row">
                ...
                <div class="form-group">
        	<input type="tel" class="form-control" name="phno" placeholder="Phone Number" required="required">
        </div>
        <div class="form-group">
	...
	<div class="text-center">Already have an account? <a href="ulogin.jsp">Sign in</a>
        </div><div>
            <div class="navbar">
