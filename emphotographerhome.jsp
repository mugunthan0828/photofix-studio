...
.aligncenter {
    ...
    <body>
        ...
        <a href="currentwork.jsp?d=<%= request.getParameter("f")%>&d1=<%= request.getParameter("f1")%>&id=${d}">current work</a>
        <a href="allwork.jsp?id=${d}">all work</a>
         <jsp:include page="viewimg.jsp">
